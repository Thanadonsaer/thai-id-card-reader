    ...
    try {
      ...
      try {
        ...
        if (openError.name === 'SecurityError') {
          setError('ไม่สามารถเปิดอุปกรณ์ได้ - การเข้าถึงถูกปฏิเสธ:\n\n' +
            '🚨 สาเหตุที่เป็นไปได้:\n' +
            '• อุปกรณ์ถูกใช้งานโดยโปรแกรมอื่น (PC/SC, smart card reader)\n' +
            '• ไม่มีสิทธิ์ในการเข้าถึงอุปกรณ์\n' +
            '• Driver ของอุปกรณ์ขัดแย้ง\n\n' +
            '🔧 วิธีแก้ไขด่วน:\n' +
            '1. ปิดโปรแกรมที่อาจใช้ USB (Task Manager)\n' +
            '2. ถอดและเสียบอุปกรณ์ใหม่\n' +
            '3. รีสตาร์ทเบราว์เซอร์\n' +
            '4. ลองใช้เบราว์เซอร์ Chrome แทน Edge\n' +
            '5. ตรวจสอบสิทธิ์ Administrator\n\n' +
            '💡 เคล็ดลับ: หากใช้ Windows ให้ลองปิด Windows Defender ชั่วคราว')
          return
        }
        throw openError
      }
